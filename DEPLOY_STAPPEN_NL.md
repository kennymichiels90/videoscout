# Deploy-stappen v12 — Streamlit Cloud

## 1. Download en unzip
Pak `digital_video_scout_mvp_v12.zip` uit.
...
Zorg dat `.streamlit/config.toml` in de **root** van je GitHub-repository staat, naast `app.py`. Niet in een extra map zoals `digital_video_scout_mvp_v12/.streamlit/config.toml`.
