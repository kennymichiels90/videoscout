# Deploy-stappen v13 — Streamlit Cloud

## 1. Download en unzip
Pak `digital_video_scout_mvp_v13.zip` uit.
...
Zorg dat `.streamlit/config.toml` in de **root** van je GitHub-repository staat, naast `app.py`. Niet in een extra map zoals `digital_video_scout_mvp_v13/.streamlit/config.toml`.
