...
APP_VERSION = "v12 Club Compact Style"
...
def set_page_style() -> None:
    ...
    st.markdown(
        ...
        .dvs-mini-header {{
            ...
            padding: 22px calc(50vw - 590px) 34px calc(50vw - 590px);
            background:
...
def hero() -> None:
    ...
    st.markdown(
        ...
        <div class="dvs-mini-header">
            <div class="dvs-nav">
                <div class="dvs-nav-left">
                    <span class="dvs-menu">☰</span>
                    <span class="dvs-nav-link">Nieuws</span>
                    <span class="dvs-nav-link active">Teams</span>
                    <span class="dvs-nav-link">Matchen</span>
                </div>
                <img class="dvs-nav-logo" src="{logo_uri}" alt="Club Brugge logo" />
                <div class="dvs-nav-right">
                    <span class="dvs-nav-btn primary">Start analyse ↗</span>
                    <span class="dvs-nav-btn">Reports ↗</span>
                </div>
            </div>
            <div class="dvs-title-row">
                <div class="dvs-title">Video Scout</div>
                <div class="dvs-mode-pills">
                    <span>Screening</span>
                    <span>Scouting</span>
                    <span>Team</span>
                </div>
...
def main() -> None:
    ...
    st.markdown(
        """
        <div class="dvs-card">
            <b>Screening</b> voor snelle eerste analyse · <b>Scouting</b> voor positie-template · <b>Team Screening</b> voor shortlist per wedstrijd.
        </div>
        """,
        unsafe_allow_html=True,
    )
