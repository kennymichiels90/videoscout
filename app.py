...
APP_VERSION = "v10 Team Screening"
...
def main() -> None:
    ...
    video_file = st.file_uploader(
        ...
        help="Uploadlimiet staat op 3000 MB via .streamlit/config.toml. Voor Team Screening mag dit een volledige wedstrijd zijn, maar upload/verwerking kan traag zijn.",
    )
