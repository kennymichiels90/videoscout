# Club Brugge Video Scout MVP v11 — Team Screening

AI-assisted football video scouting app built with Streamlit + OpenAI API.

## Nieuw in v11

v11 voegt een derde module toe: **Team Screening**.
...
Standaard gebruikt v11 `gpt-5-mini` om de kosten lager te houden.
