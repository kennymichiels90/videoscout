# Club Brugge Video Scout MVP v13 — Team Screening

AI-assisted football video scouting app built with Streamlit + OpenAI API.

## Nieuw in v13

v13 voegt een derde module toe: **Team Screening**.
...
Standaard gebruikt v13 `gpt-5-mini` om de kosten lager te houden.
