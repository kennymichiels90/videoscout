# Club Brugge Video Scout MVP v15 — Team Screening

AI-assisted football video scouting app built with Streamlit + OpenAI API.

## Nieuw in v15

v15 voegt een derde module toe: **Team Screening**.
...
Standaard gebruikt v15 `gpt-5-mini` om de kosten lager te houden.
